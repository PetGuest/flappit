...
app.use(express.static(path.join(__dirname, "web"), {redirect:false})); // redirect:false: /en debe servir 200 (no 301 a /en/) — GSC marcaba "Error de redirección" y el canonical apunta a /en
